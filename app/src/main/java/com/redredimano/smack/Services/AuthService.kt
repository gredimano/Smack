...
import com.redredimano.smack.Utilities.URL_CREATE_USER
import com.redredimano.smack.Utilities.URL_LOGIN
...
object AuthService {
    ...
    fun createUser(context: Context, name: String, email: String, avatarName: String, avatarColor: String, complete: (Boolean) -> Unit) {
        ...
        val createRequest = object : JsonObjectRequest(Method.POST, url, null, Response.Listener { response ->
